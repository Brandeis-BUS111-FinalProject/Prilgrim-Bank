...
summary(consumerDB)
### consumerDB3 = consumerDB
### consumerDB3$X9Profit = (consumerDB$X9Profit)/20
### summary(consumerDB3)

#consumerDB$logProfit=consumerDB3
```
...
```{r}
#table(x=consumerDB$Tenure.Level,y=consumerDB$X0Online)
#table(x=consumerDB$Tenure.Level,y=consumerDB$X9Age)
```
